...
*
*@author Xavier Vilà Puig <xvila225@gmail.com>
*
*/

/**
*Classe ke utilitza l'aplicació per gestionar la BBDD.
*
*
*@version v1.0.0
*/
class BDD {
	...
	*
	*@link http://localhost/dawusuaris Més documentació
	*@see http://localhost/dawusuaris Mireu també
	*@todo Falta implementar en que retorni si no esta activat o no.
	*@uses crearConnexio()
	*@param string $user Nom de l'usuari que fa el login.
	*@param string $pass Contrasenya de l'usuari que fa el login.
	*@return boolean true si existeix a la BDD, false altrament.
	*/	
